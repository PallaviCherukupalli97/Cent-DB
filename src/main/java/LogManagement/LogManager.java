...
public class LogManager {
	...
	public static void queryLog(String query , String timest) {
		...
		try {
			FileWriter fw = new FileWriter(System.getProperty("user.dir") + "/assets/logs/Query.txt", true);
	...
	public static void generalLog(String msg) {
		try {
			FileWriter fw = new FileWriter(System.getProperty("user.dir") + "/assets/logs/General.txt", true);
			fw.close();
		}
		catch(IOException e) {
			e.printStackTrace();
	...
	public static void eventLog(String msg) {
		try {
			FileWriter fw = new FileWriter(System.getProperty("user.dir") + "/assets/logs/Event.txt", true);
			fw.close();
		}
		catch(IOException e) {
			e.printStackTrace();
